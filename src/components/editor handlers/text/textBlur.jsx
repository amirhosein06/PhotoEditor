...
const TextBlur = () => {
    ...
    return ( 
        <Container>
          <Title>تـاری مـتـن</Title>
        <InputRange type="range" onChange={changeFontBlur} defaultValue={inputDefultVal()} min={0} max={7}/>
        </Container>
     );
}
